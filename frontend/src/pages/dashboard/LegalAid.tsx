    ...
    <DashboardLayout>
      <div>
        ...
        <p className="mt-1.5 text-sm text-dark-gray/70 dark:text-white/70 max-w-2xl leading-relaxed">
          Track legal cases from intake through resolution — custody
          disputes, protection orders, and more — each assigned to a
          partner legal professional and monitored until closed.
        </p>
      </div>
